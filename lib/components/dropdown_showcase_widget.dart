...
import 'dropdown_showcase_model.dart';
export 'dropdown_showcase_model.dart';

class DropdownShowcaseWidget extends StatefulWidget {
  const DropdownShowcaseWidget({super.key});
...
class _DropdownShowcaseWidgetState extends State<DropdownShowcaseWidget>
  ...
  late DropdownShowcaseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DropdownShowcaseModel());
