...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'task_CreateEdit',
          path: '/taskCreateEdit',
          asyncParams: {
            'taskRef': getDoc(['tasks'], TasksRecord.fromSnapshot),
          },
          builder: (context, params) => TaskCreateEditWidget(
        ...
        FFRoute(
          ...
          path: '/mainTasks',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'main_Tasks')
        ...
        FFRoute(
          ...
          path: '/mainCalendar',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Main_Calendar')
        ...
        FFRoute(
          name: 'manager_Home',
          path: '/managerHome',
          builder: (context, params) => const ManagerHomeWidget(),
        ),
        FFRoute(
          name: 'main_Drag',
          path: '/mainDrag',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'main_Drag')
              : const MainDragWidget(),
        ),
        FFRoute(
          name: 'main_Drag_liveStream',
          path: '/mainDragLiveStream',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'main_Drag_liveStream')
              : const MainDragLiveStreamWidget(),
        )
